/*Write a program to approximation the functional value at any given x from a given n no. og data using Newton's Central Divided difference interpolation */
#include<iostream>
//#include<cmath>
using namespace std;
